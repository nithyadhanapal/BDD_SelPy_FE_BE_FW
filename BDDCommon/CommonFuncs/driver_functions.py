...
def go_to(context, location, **kwargs):
    ...
    if not location.startswith('http'):
        # If location doesn't start with http like '/my-account'
...
def type_into_element(context_or_element, input_value, locator_attr, locator_text):
    ...
    :param context_or_element: If the input field is element
            "webdriver.remote.webelement.WebElement" is the type of web element
    :param input_value:
    :param locator_attr: Locator type
    :param locator_text: Locator
    :return:
    """
    if isinstance(context_or_element, webdriver.remote.webelement.WebElement):
